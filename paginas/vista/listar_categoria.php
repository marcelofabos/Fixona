...
background: linear-gradient(to right, #FFFFFF, #6DD5FA, #2980B9); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */">
    ...
    <div class="container mt-3">
        <header>
            <h1><i class="fas fa-list-alt"></i> Categorias</h1>
            <hr />
        </header>

        <nav>
            <div class="btn-group col-md-5" role="group">
                <a href="registrar_categoria.php" class="btn btn-outline-primary">
                ...
                <div class="row justify-content-center mt-3">
                    <div class="col-md-6">
                        <table class="table table-hover table-sm table-success">
                            ...
                            $i = 0;
                            foreach ($rs_cate as $categoria) {
                                $i++;
                            ?>
                                <tr class="reg_categoria">
                                    <td><?= $i ?></td>
                                    <td class="id_cate"><?= $categoria->id_categoria ?></td>
                                    <td class="categoria"><?= $categoria->nombre_categoria ?></td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-danger" id="staticBackdropLael"><i class="fas fa trash-alt"></i> Borrar Categoria</h4>
                ...
                <div class="modal-body">
                    <div class="row justify-content-center">
                        ...
                        <p class="card-text">
                            <span class="lbl_categoria"></span> (<span class="lbl_id_cate"></span>)
                        </p>
                    </div>
                </div>

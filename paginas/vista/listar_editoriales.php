    ...
    <div class="container mt-3">
        ...
        <nav>
            <div class="btn-group col-md-5" role="group">
                <a href="registrar_editoriales.php" class="btn btn-outline-primary">
                    <i class="fas fa-plus-circle"></i> Registrar
                </a> 
                <a href="consultar_editoriales.php" class="btn btn-outline-primary">
                    <i class="fas fa-search"></i> Consultar
                </a>
                <a href="filtrar_editoriales.php" class="btn btn-outline-primary">

...
">
    ...
    <div class="container mt-3">
        <header>
            <h1><i class="fas fa-search"></i> Filtrar Ventas</h1>
            <hr />
        </header>
        ...
        <section>
            <article>
                <div class="row justify-content-center mt-3">
                    <div class="col-md-5">
                        <form id="frm_filtrar_ven" name="frm_filtrar_ven" method="post">
                            <div class="input-group mb-3">
                                ...
                                <a class="btn btn-outline-primary" href="filtrar_venta.php">Nuevo</a>
                            </div>
                        </form>

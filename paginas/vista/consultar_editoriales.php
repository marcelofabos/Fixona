...
">
    ...
    <div class="container mt-3">
        <header>
            <h1><i class="fas fa-search"></i> Consultar Editorial</h1>
            <hr />
        </header>
            ...
            <article>
                <div class="row justify-content-center mt-3">
                    <div class="card col-md-6">
                        <div class="card-body">
                            <form id="frm_consultar_edit" name="frm_consultar_edit" method="post">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label for="txt_id_edito" class="frm-label">Código</label>
                                        <input type="text" class="form-control" id="txt_id_edito" name="txt_id_edito" placeholder="Código a buscar" maxlength="5" autofocus />
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="row align-items-start">
                                            <div class="col">
                                                ...
                                                <p class="id_editoriales card-text">&nbsp;</p>
                                            </div>
                                            <div class="col">
                                                <h5 class="card-title">Editorial</h5>
                                                <p class="edito card-text">&nbsp;</p>
                                            </div>
                                            <div class="col">
                                                <h5 class="card-title">Pais</h5>
                                                <p class="pais card-text">&nbsp;</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="text-center mt-3">
                                <a type="submit" href="consultar_editoriales.php" class="btn btn-outline-primary">

...
">
    ...
    <div class="container mt-3">
        <header>
            <h1><i class="fas fa-search"></i> Consultar Categoria</h1>
            <hr />
        </header>
            ...
            <article>
                <div class="row justify-content-center mt-3">
                    <div class="card col-md-6">
                        <div class="card-body">
                            <form id="frm_consultar_cate" name="frm_consultar_cate" method="post">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label for="txt_id_cate" class="frm-label">Código</label>
                                        <input type="text" class="form-control" id="txt_id_cate" name="txt_id_cate" placeholder="Código a buscar" maxlength="5" autofocus />
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="row align-items-start">
                                            <div class="col">
                                                ...
                                                <p class="id_cate card-text">&nbsp;</p>
                                            </div>
                                            <div class="col">
                                                <h5 class="card-title">Categoria</h5>
                                                <p class="cate card-text">&nbsp;</p>
                                            </div>
                                        </div>
                                    </div>
